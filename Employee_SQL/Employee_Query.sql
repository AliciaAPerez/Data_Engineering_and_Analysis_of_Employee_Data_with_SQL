...
-- Quick Reference for tables and columns names:
...
-- Query 1 - employee details: employee number, last name, first name, sex, salary
SELECT e.employee_number, e.last_name, e.first_name, e.sex, s.salary
FROM employees AS e
LEFT JOIN salaries AS s
ON e.employee_number = s.employee_number;

-- Query 2 - employee details: first name, last name, hire date for employees hired in 1986
SELECT first_name, last_name, hire_date
FROM employees
WHERE EXTRACT(YEAR FROM hire_date) = '1986';

-- Query 3 - manager details: department number, department name, manager's employee number, last name, first name
...
-- QUery 4 - employee department details: employee number, last name, first name, department name
...
-- Query 5 - first name, last name, sex employees with first name "Hercules" and last name being with "B"
SELECT first_name, last_name, sex
FROM employees 
WHERE first_name = 'Hercules'
AND last_name LIKE 'B%';

-- Query 6 - employees in sales department with employee number, last name, first name, department name
...
-- Query 7 - all employees in sales and development departments with employee number, last name, first name, department name
-- employees does not include managers
SELECT e.employee_number, e.last_name, e.first_name, d.dept_name
FROM employees AS e
LEFT JOIN dept_employee AS de
...
-- Query 8 - in descending order, frequency count of last names
